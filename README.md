...
3.The project isn't complex in concept however, if you decide to contiue using react, it will take some time to build properly and then optimize for the best user experiance esp. when it comes to file size.
